...
* 修改默认的“扫一扫”书签目标网址
* 修复首页书签无法正常添加书签的问题
* 设置页“关于”项增、改功能。单击：检测版本更新并显示部分信息；长按：打开“关于本主页”页面（本地MEADME.md文件，包含至当前使用版本时的主页介绍、更新日志等）
* 设置页长按或双击“自定义设置”标题，可以进入或退出“开发者模式”。开发者模式下会有部分待完善或正在测试的功能（测试功能选项的修改可能会导致页面显示错误或相关联功能异常）
* 设置页开发者模式增加“语音搜索”和“长文本搜索”功能
* 在1.25.1中修复了本地README文件加载错误的问题，修复主页书签有时会无法点击长按的问题，增加头条搜索
...
* 修复长按LOGO功能设置消失的问题
* 在1.23.1中修复了删除全部主页书签后会导致主页不可用的问题，并在设置中添加了书签显示功能

<版本 1.22>
* 添加书签页面新增书签库功能，便于添加默认书签
* 更改精选页天气api、微博/知乎/抖音api，并优化算法
* 设置页新增精选页天气相关设置，并在设置页底部增加天气api网站入口
* 设置页支持修改chrome浏览器书签地址

<版本 1.21>
* chrome插件版主页LOGO点击/长按功能支持设置为“打开书签”

<版本 1.20>
* 优化LOGO上传功能。现在上传LOGO后会增加一个LOGO图片自适应过程，自动调整LOGO高度
* 优化LOGO高度设置功能。现在LOGO高度默认值将根据设备宽度自动调整
